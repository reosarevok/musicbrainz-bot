...
WHERE edits_pending = 0
    AND url LIKE 'http://classic.beatport.com/%'
LIMIT 1000
''')
...
def main(verbose = False):
    edit_note = """Updating Beatport HTTP URLs to HTTPS and changing "classic" to "www", as per Beatport's own redirects. See https://tickets.metabrainz.org/browse/MBBE-10"""
    if verbose:
